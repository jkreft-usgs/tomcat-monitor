...
Finally, the <span style='font-weight: bold;'>web app hosted by Tomcat</span> is a Java app that, again, needs to self-report. Tomcat can give information on the Tomcat-level resources being used by the app, but the application's internal logic is opaque to Tomcat.
